...
public class ButcherBlock extends WorkplaceBlock {

    public static final MapCodec<ButcherBlock> CODEC = simpleCodec(ButcherBlock::new);

    public ButcherBlock(BlockBehaviour.Properties properties) {
        super(properties);
    }
